...
class UsageRightsController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $row = UsageRight::query()->where('user_id', $userId)->findOrFail($data['id']);
    ...
    public function destroy(Request $request)
    {
        ...
        $row = UsageRight::query()->where('user_id', $userId)->findOrFail($id);
        $row->delete();
